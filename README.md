...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/venkateshk/yadr/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/venkateshk/yadr/master/install.sh`" -s ask
```
